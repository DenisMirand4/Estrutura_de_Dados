...
Node buscaNo(SrbStruct *t, double x, double y, NoStruct *node, double *mbbX1, double *mbbY1, double *mbbX2, double *mbbY2)
{
    if (node == t->nil)
    {
        return NULL;
...
{
    SrbStruct *srb = (SrbStruct *)t;
    Node *aux = buscaNo(srb, xa, ya, srb->root, mbbX1, mbbY1, mbbX2, mbbY2);
    if (aux == NULL){
        return NULL;
    }
