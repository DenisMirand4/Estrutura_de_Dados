...
int main(int argc, char *argv[]){
    ...
    while (i < argc)
    {
        if(strcmp("-f", argv[i]) == 0){
            ...
            parGEO = (char*)malloc((strlen(argv[i])+2)*sizeof(char));
            ...
            parQRY = (char*) malloc((strlen(argv[i]+2))*sizeof(char));
            ...
            saidDiretorio = (char*) malloc((strlen(argv[i]+2))*sizeof(char));
    ...
    criarCidade(diretorio, saidDiretorio, parGEO, parQRY);
